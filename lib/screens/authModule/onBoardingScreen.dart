  ...
  final List<Map<String, String>> _pages = [
    {
      ...
      "title2": " Our Driver",
      "subtitle1":
      "Get a professional driver anytime, anywhere—",
      "subtitle2": "\ntap, ride, relax.",
    ...
    },
    {
      ...
      "title2" : "Drivers",
      "subtitle1":
      "Every driver is verified for a safe, reliable,",
      "subtitle2": "\nstress-free ride.",
    ...
    },
    {
      ...
      "title2": " Your Way",
      "subtitle1":
      "Pay only for what you use—hourly, daily per trip.",
                        ...
                        text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                              ...
                              style: TextStyle(fontSize: 30, fontWeight: FontWeight.w600, color: ConstColors().themeColor),
                            ),
                          ],
                        ),
                      ),
                        ...
                        TextSpan(
                          ...
                          children: [
                            TextSpan(
                              ...
                              style: TextStyle(fontSize: 18, fontWeight: FontWeight.w400, color: ConstColors().themeColor),
                            ),
                          ],
                        ),
