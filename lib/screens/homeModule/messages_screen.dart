      ...
      child: SafeArea(
        child: Column(
          children: [
            Row(
              children: [
                const Icon(Icons.mic, color: Color(0xFFFF2800)),
                      ...
                      Expanded(
                        child: TextField(
                          decoration: InputDecoration(
                            ...
                            filled: true,
                            fillColor:
                            const Color(0xFFFF2800).withOpacity(0.08),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: const Color(0xFFFF2800).withOpacity(message!.isSender ? 1 : 0.1),
      ),
      child: Row(
        children: [
          Icon(
            Icons.play_arrow,
            color: message!.isSender ? Colors.white : const Color(0xFFFF2800),
          ),
          Expanded(
            child: Padding(
                ...
                children: [
                  Container(
                    ...
                    color: message!.isSender
                        ? Colors.white
                        : const Color(0xFFFF2800).withOpacity(0.4),
                  ),
                  Positioned(
                    left: 0,
                    child: Container(
